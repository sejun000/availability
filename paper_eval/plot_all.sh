...
--y1_min 0 --y1_max 14 --y1_interval 2 \
--y2_min 0 --y2_max 14 --y2_interval 2 \
...
--y_min 0 --y_max 0.6 --y_interval 0.1 \
...
--filter_expr "m+k==48" \
--y1_label "Availability (Nines)" --y1_expr "credit_avail_nines" \
--y2_label "Hours" \
...
--y2_min 0 --y2_max 20 --y2_interval 5 \
--legend_location1 "upper left" \
--legend_location2 "upper left" \
...
--title3 "(c) DWPD=0.33" \
--title4 "(d) DWPD=1" \
--filter_expr1 "k==3&dwpd==0.01&cached_ssds!=12&cached_ssds!=10" \
--filter_expr2 "k==3&dwpd==0.1&cached_ssds!=12&cached_ssds!=10" \
--filter_expr3 "k==3&dwpd==0.33&cached_ssds!=12&cached_ssds!=10" \
--filter_expr4 "k==3&dwpd==1&cached_ssds!=12&cached_ssds!=10" \
--y_total_label "M$" \
--y_min 0 --y_max 24 --y_interval 4 \
--legend_location "upper left" \
--z_col 4 \
...
--filtered_expr "(~((k==0)&(network_k==0)))&(((m+k)>=24)|((network_m+network_k)<=24))&(box_mttf==4166666)" \
...
--y_min 0,0,0,0.15 --y_max 14,14,40,0.35 --y_interval 2,2,5,0.05 \
