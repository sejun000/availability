...
#table = filtered_df.pivot(index='k', columns='col', values='total_cost_for_10_years')
table = filtered_df.pivot(index='k', columns='col', values='cost_per_gb')
#table = filtered_df.pivot(index='k', columns='col', values='down_cost_for_10_years')
