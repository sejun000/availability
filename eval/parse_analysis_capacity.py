...
#table = filtered_df.pivot(index='k', columns='capacity', values='avail_nines')
#table = filtered_df.pivot(index='k', columns='capacity', values='eff_avail_nines')
#table = filtered_df.pivot(index='k', columns='capacity', values='total_cost_for_10_years')

table = filtered_df.pivot(index='k', columns='capacity', values='cost_per_gb')
#table = filtered_df.pivot(index='k', columns='capacity', values='down_cost_for_10_years')
#table = filtered_df.pivot(index='k', columns='capacity', values='repair_cost_for_10_years')
#table = filtered_df.pivot(index='k', columns='capacity', values='initial_cost')
#table = filtered_df.pivot(index='k', columns='config_file', values='operation_cost_for_10_years')
#table = filtered_df.pivot(index='k', columns='capacity', values='avg_time_for_rebuilding')
