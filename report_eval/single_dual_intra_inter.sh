...
total_ssds=48
python="pypy3"
target_ratio=(1 1 0.5)

tier_files=("2tier.json" "2tier.json" "2tier-singleport.json")

active_actives=("--active_active" "" "")
box_mttfs=(7277969952 7277969952 7277969952) # 1 year, 1 month, 1 day, 1 hour
io_module_mttrs=(0.25 0.25 4) # 4 hours
