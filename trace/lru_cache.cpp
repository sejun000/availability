...
LRUCache::LRUCache(long capacity, int _cache_block_size, bool _cache_trace, const std::string &trace_file, const std::string &cold_trace_file) : capacity_(capacity), cache_block_size(_cache_block_size), cache_trace(_cache_trace), allocator(capacity * _cache_block_size, _cache_block_size) {
...
void LRUCache::batch_insert(const std::set<long> &newBlocks, OP_TYPE op_type) {
